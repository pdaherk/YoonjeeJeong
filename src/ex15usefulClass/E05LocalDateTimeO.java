...
public class E05LocalDateTimeO {
	...
	public static void main(String[] args) {
		...
		System.out.println("3일후의 12시:" + day3Later);
		
		//앞으로 2시간 10분 후
		System.out.println("2시간 10분 후: "+ nowDateTime.plusHours(2).plusMinutes(10));
		
		//가장 가까운 요일, n번째 요일 등을 간단한 코드로 가져올 수 있음
		LocalDateTime nowSunday = LocalDateTime.now().with
		...
		System.out.println("2020/3/1기준, 네번째 일요일: "+ fourthSunday);
		
		LocalDate first12Sunday = LocalDate.of(2020, 3, 1).with(TemporalAdjusters.
		...
		System.out.println("클래스 실행 시간 확인(2시간의 차): "+duration.toMillis());
		System.out.println(nowDate.getMonth());//현재날짜 기준으로 현 월(月)
	}
