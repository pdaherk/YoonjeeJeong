...
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		Integer n200bj = new Integer(num2);//num2=20
		int result2 = n100bj.intValue() + n200bj.intValue();//10+20
		...
		Integer numObj1 = 100;//오토언박싱 처리
		Integer numObj2 = 200;
		int num3 = numObj1;//오토언박싱 처리
		int result3 = numObj1 - numObj2;
		System.out.println("오토언박싱 이후 연산:"+ result3);
		/*wrapper클래스를 사용하는 이점
		...
		/* 자바의 모든 클래스는 Object 클래스를 상속받음.
		 ...
		 - toString(): 인스턴스변수를 출력시 참조값이 아니라 실제
		 			저장된 값을 문자열 형태로 반환해주는 메소드
