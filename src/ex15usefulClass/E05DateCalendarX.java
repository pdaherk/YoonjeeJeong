...
public class E05DateCalendarX {
	...
	static String myDateFormat(Calendar cal) {
		//메소드에 이름만으로 기능을 유추하기 어려움
		date = cal.getTime();//메소드명이 time인데 반환형은 Date(날짜)이다
		return new SimpleDateFormat("yyyy-MM-dd").format(date);//달은 반드시 대문자로(MM)
	}
	...
	public static void main(String[] args) {
		...
		//월을 표현하는 상수가 실제 월보다 -1 차이가 난다(12월은 11이다)
		System.out.println("JANUARY는 1월인데...: "+ Calendar.JANUARY);
		System.out.println("DECEMBER가 11월이였나? : "+ Calendar.DECEMBER);
