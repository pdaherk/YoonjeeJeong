...
/*
 ...
 객체생성은 하지 않음. 상속의 목적으로만 정의된 클래스이다 
 */
class Friend {
	String name;
	String phone;
	...
	/*
	아래: 간략한 정보만 출력하는 메소드로, 현재 실행부가 
	없는 상태로 정의됨. 여기서는 오버라이딩을 할 목으로 정의되었음. */
...
class HighFriend extends Friend {
	...
	고등학교 친구 전체정보 출력을 위해 부모에서 정의된 메소드를
...
class FriendInfoHandler {
	...
	public void showAllData() {
		...
		/*
		1. 고딩친구 정보를 추가
		2. High객체가 Friend타입으로 자동현변환되어 저장
		3. 객체배열에 저장된 객체들을 for문을 통해 순차적으로 출력
			이때 오버라이딩된 메소드를 통해 항상 해당 객체의
			정보를 출력할 수 있음.(참조변수의 타입에 영향을 받지 않음) */
