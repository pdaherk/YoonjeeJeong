...
public class ex02variable {
	...
	public static void main(String[] args) {
		...
		/*
		 실수자료형
		 -정수형보다는 실수형이 더 큰 자료형이다. 0과 1사이에 무수한 실수가 존재함
		...
		System.out.println("long1 + float 1 = "+ result1);
		...
		/*실수형에서 기본형은 double 임
		  ...
		  - 소수점이 있는 데이터를 float에 대입하려면 접미사 (f 또는 F)를 사용한다
		  - 형변환도 가능은 하지만 Java에서는 권장하지 않는다
		 */
		
		float f3 = 100;
		
		//float f4 = 3.14; 에러 남. 더블로 인식하게 됨.
		float f4 = (float)3.14;//형변환후 대입(권장사항 아님)
		System.out.println("f4="+ f4);
		
		float f5 = 3.14F;//자바에서는 접미사 사용 권장함
