...
public class E05ConstantVar {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 -선언시 전체를 대문자로 선언하며, 연결되는 단어가 있는 경우 _(언더스코어)
		 를 사용한다.
		...
		//PI = 3.141593; // 상수는 한번 초과하면 변경 불가능
		
		//상수가 초기화되지 않는 상태에서 출력하면 에러남 (NICK_NAME을 초기화 하지 않았음)
		...
		/*
		 PAPER와 같으 단어는 누가 보더라도 이해할 수 있으므로 가독성이
		 높은 명시적인 코드가 된다.
		 */
		computer = SCISSOR;
		user = PAPER;
