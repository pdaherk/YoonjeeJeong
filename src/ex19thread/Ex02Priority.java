	...
	public void run() {
		for(int i=1 ; i<=1000 ; i++) {
			...
			/*
			 ...
			 sleep()메소드를 사용하게 되면 실행 중 블럭상태로 전환되어
...
public class Ex02Priority {
	...
	public static void main(String[] args) {
		/*
		 1단계: 우선순위를 별도로 지정하지 않은 상태로 쓰레드를 생성하면
		 동일한 우선순위 5를 부여받게 된다.
		 이때는 cpu가 알아서 직업을 분배한다. */
...
//		MessageSendingThread tr3 = new MessageSendingThread("세번째");
		...
		/*
		 2단계: 우선순위 부여를 위해 Thread클래스에 static타입의 상수를 이용한다 
...
//		MessageSendingThread tr2=
//				new MessageSendingThread("첫번째", 5);
//		MessageSendingThread tr3=
//				new MessageSendingThread("첫번째", 1);
