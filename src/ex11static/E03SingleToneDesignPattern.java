package ex11static;
/*싱글톤 디자인 패턴:
 	하나의 인스턴스 즉 하나의 메모리를 생성해 이를 공유해서 
 	사용하고자 할 때 사용하는 패턴이다
	 ...
	 4. 위 방법을 통해 객체를 생성하면 메모리에 하나만 만들어지게 됨  */
...
class SingleTone {
	...
	new연산자를 통해 객체생성은 불가능해짐 . private은 무조건 자기 자신만 접근이 가능!*/
	private SingleTone() {
		//기본생성자
	/*
	...
	public static SingleTone getInstance() {//객체형태도 반환 가능함(SingleTone이라는 객체)
		return single;
	}
	void print() {
...
public class E03SingleToneDesignPattern {
	...
	public static void main(String[] args) {
		...
		//생성자가 private로 선언되었으므로 외부에서는 접근불가
		//SingleTone st1 = new SingleTone();//error
