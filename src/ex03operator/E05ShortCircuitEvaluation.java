...
public class E05ShortCircuitEvaluation {
	...
	/*
	 ...
	 하나의 조건검사만으로 결과를 알 수 있는 경우 JAVA라는 컴파일러는
	...
	public static void main(String[] args) {
		...
		boolean result;
		/*
		 &&(AND)의 경우 둘 중 하나만 false 이면 false를 반환하므로
		 첫번째 조건이 false이면 두번째 조건을 검사(수행) 안 함
		 */
		result = (num1+10)<0 && (num2)>0;
		System.out.println("result="+ result);//false
		System.out.println("num1="+ num1 +", num2="+ num2);//num1=10, num2=0
		/*
		 ||(논리 or)의 경우 둘 중 하나만 true면 true반환함.
		 따라서 첫 번째 조건이 true이면 두번째 조건을 검사하지 않는다.1
		 */
